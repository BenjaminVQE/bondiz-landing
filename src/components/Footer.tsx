    ...
    <footer style={{
      ...
      <div className="container" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          ...
          <a
            href="https://www.instagram.com/bondiz_app"
            target="_blank"
